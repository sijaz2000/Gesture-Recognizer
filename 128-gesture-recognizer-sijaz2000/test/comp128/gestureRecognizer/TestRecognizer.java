...
//    private CanvasWindow canvas;
   ...
   public void testCentroid(){
       assertEquals(new Point(9.5, 0), recognizer.centroid(originalPoints)); 
   }

   @Test

   public void testBoundingBox(){
       assertEquals(new Point(19, 0), recognizer.boundingBox(originalPoints));
   }
   ...
   public void testRecognize(){
       ...
       double score = recognizer.recognize(testGesture);;

       assertEquals(0.888684, score, 0.001); 

       score = recognizer.recognize(templateGesture);
